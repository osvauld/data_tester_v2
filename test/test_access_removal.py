...
from service.access_removal_service import remove_user_access_for_credential, remove_user_access_for_folder, \
    remove_group_access_for_credential, remove_group_access_for_folder
...
from service.share_credential_service import (share_credentials_with_users,
                                              share_folder_with_users, share_credentials_with_groups,
...
class TestCredentialAccessRemovalForUser(unittest.TestCase):
    ...
    def test_access_removal(self):
        ...
        self.assertEqual(self.credential.credential_id, fetched_credential.credential_id)
...
class TestFolderAccessRemovalForUser(unittest.TestCase):
    ...
    def test_access_removal_with_multiple_access(self):
        ...
        # share credential with user
        response = share_credentials_with_users(
            credential_ids=[credential.credential_id for credential in self.credentials],
            share_to_users_with_permission=[share_credential_to_user],
            share_from_user=self.share_from_user,
        )
        self.assertTrue(response["success"])
...
class TestCredentialAccessRemovalForGroup(unittest.TestCase):
    ...
    def setUp(self):
        ...
        add_member_to_group(
            group_id=self.group_id, new_member=self.share_to_user, caller=self.share_from_user
        )
    ...
    def test_access_removal(self):
        ...
        # should have the highest access
        self.assertEqual(fetched_credential.access_type, share_to_group_with_permission["access_type"])
    ...
    def test_access_removal_with_multiple_access(self):
        ...
        # should have the highest access
        self.assertEqual(fetched_credential.access_type, share_credential_to_group["access_type"])
